...
class SeoDetailPolicy
{
    ...
    {
        return $user->can('view_any_seodetail');
    }
    ...
    {
        return $user->can('view_seodetail');
    }
    ...
    {
        return $user->can('create_seodetail');
    }
    ...
    {
        return $user->can('update_seodetail');
    }
    ...
    {
        return $user->can('delete_seodetail');
    }
    ...
    {
        return $user->can('delete_any_seodetail');
    }
