...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    public static function table(Table $table): Table
    {
        ...
        // ->action(function ($records, $data, $livewire) {
        //     $protectedRecords = $records->filter(fn ($record) => $record->name == config('filament-shield.super_admin.name'));
        //     $deletableRecords = $records->diff($protectedRecords);
        ...
        //         Notification::make()
        //             ->title(__('Records Deleted'))
        //             ->success()
        //             ->send();
        //     }

        //     if ($protectedRecords->isNotEmpty()) {
        //         // Notify about protected records
        //         Notification::make()
        //             ->title(__('Protected Records Not Deleted'))
        //             ->danger()
        //             ->send();
        //     }

        //     // If no records were deletable, notify that none were deleted
        //     if ($deletableRecords->isEmpty() && $protectedRecords->isEmpty()) {
        //         Notification::make()
        //             ->title(__('No Records Deleted'))
        //             ->danger()
        //             ->send();
        //     }
        // })
