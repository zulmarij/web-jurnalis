    ...
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li class="flex">
                            Email: <a href="mailto:hmg@thestance.id" class="ml-2 hover:underline">Partnership@thestance.id</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex mb-4 space-x-6 sm:justify-center sm:mb-0 order-1 sm:order-2">
                ...
                <a href="https://www.instagram.com/thestanceid" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
