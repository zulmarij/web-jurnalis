    ...
    <div class="mx-auto max-w-screen-xl">
        ...
        <div class="md:flex md:justify-between">
            {{-- <div class="mb-6 md:mb-0">
                ...
                <p class="max-w-sm text-gray-600 dark:text-gray-400 text-sm mt-6">{{ $siteDescription }} Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis neque eos, quae laboriosam similique, alias </p>
            </div> --}}
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400 order-2 sm:order-1">©
